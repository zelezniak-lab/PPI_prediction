...
def return_embedding_vectors_from_dict(sequences,protein_name, model_name = 'prot_xlnet'):
    """ 
    ...
    tokenizer = XLNetTokenizer.from_pretrained(f"Rostlab/{model_name}", do_lower_case=False)
    model = XLNetModel.from_pretrained(f"Rostlab/{model_name}")
